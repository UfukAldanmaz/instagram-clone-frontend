...
export const Popup: React.FC<PopupProps> = ({ trigger, setTrigger }) => {
  ...
  return trigger ? (
    ...
    >
      <div className="relative h-auto items-center p-8 w-2/5 h-1/2 bg-white rounded-lg">
        <div className="p-4 border-b rounded-t text-center items-center dark:border-gray-600">
          <button
            onClick={handleClose}
            type="button"
            className="absolute border-transparent hover:border-transparent focus:ring-0  text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg  text-sm  top-4 right-4 items-center ml-auto text-center"
          >
            <svg
              className="w-3 h-3"
